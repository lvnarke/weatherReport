                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                    ...
                    <form action="submit" method="post" role="form" class="php-email-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" data-rule="minlen:4"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="guideName" data-rule="minlen:3"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="department" data-rule="minlen:3"
                                   data-msg="Please fill this field" />
                            <div class="validate"></div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group text-center">
                                <a class="get-started-btn text-center" id="upload-button">Upload</a>
                                <input type="file" id="file-input" style="display: none;" accept=".pdf" /><br>
                            </div>
                        ...
                        <div class="form-group text-center">
                            <a class="get-started-btn text-center" id="pay-button">Pay</a>
                        </div>

                        <div id="Cost" class="text-center"></div>
...
<script>
    ...
    fileSelector.addEventListener('change', (event) => {
        ...
        reader.onloadend = function () {
            ...
            document.getElementsByName("fileName").innerHTML = '<input type="text" class="form-control" name="fileName" placeholder=' + fileName + 'disabled />'
            calculateCost(count)
        }
    });
    ...
    function calculateCost(count) {
        ...
        upiName = 'shekar'
        bankName = 'citi'
        document.getElementById("Cost").innerHTML = '<strong> &#8377 ' + cost + '.00;</strong>';
    }
